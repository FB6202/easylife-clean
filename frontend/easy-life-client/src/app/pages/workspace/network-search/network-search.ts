  ...
  readonly allResults = signal<SearchResult[]>([
    {
      ...
      firstname: 'Sarah',
      lastname: 'Creates',
      bio: 'Product designer & creative director. Building beautiful things one pixel at a time.',
      avatarColor: '#e91e63',
      initials: 'SC',
      publicGoals: 3,
      publicCategories: 7,
    ...
    },
    {
      ...
      firstname: 'Felix',
      lastname: 'Dev',
      bio: 'Full-stack developer. Loves clean code, good coffee and building side projects.',
      avatarColor: '#43a047',
      initials: 'FD',
      publicGoals: 8,
      publicCategories: 5,
    ...
    },
    {
      ...
      firstname: 'Lena',
      lastname: 'Builds',
      bio: 'Startup founder & product strategist. Helping teams ship faster.',
      avatarColor: '#9c27b0',
      initials: 'LB',
      publicGoals: 6,
      publicCategories: 4,
    ...
    },
    {
      ...
      firstname: 'Tom',
      lastname: 'Strategy',
      bio: 'Business strategist and advisor. OKRs, systems thinking and growth.',
      avatarColor: '#1976d2',
      initials: 'TS',
      publicGoals: 4,
      publicCategories: 3,
    ...
    },
    {
      ...
      firstname: 'Mia',
      lastname: 'Founder',
      bio: 'Serial entrepreneur. Currently building a SaaS for remote teams.',
      avatarColor: '#795548',
      initials: 'MF',
      publicGoals: 7,
      publicCategories: 5,
    ...
    },
    {
      ...
      firstname: 'Jan',
      lastname: 'Data',
      bio: 'Data engineer at scale. Making sense of big data, one pipeline at a time.',
      avatarColor: '#00bcd4',
      initials: 'JD',
      publicGoals: 2,
      publicCategories: 2,
